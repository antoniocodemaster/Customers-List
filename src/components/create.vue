    ...
    <form action v-on:submit.preventDefault="createCustomer()">
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" v-model="newCustomer.name.first" />
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label for>Last Name</label>
            <input type="text" class="form-control" v-model="newCustomer.name.last" />
          </div>
        </div>
      </div>
      <div class="row">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            <label for>Age</label>
            <input type="text" class="form-control" v-model="newCustomer.dob.age" />
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label for>Gender</label>
            <input type="text" class="form-control" v-model="newCustomer.gender" />
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" v-model="newCustomer.location.street" />
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for>City</label>
            <input type="text" class="form-control" v-model="newCustomer.location.city" />
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for>Zip Code</label>
            <input type="text" class="form-control" v-model="newCustomer.location.postcode" />
          </div>
        </div>
      </div>
      <div class="row">
